...
if($v){
	foreach($x as $m){
		...
		<div class="sol2">
		 ...
		 <div class="bilgi">Kategori: <?php echo $m["kategori_adi"];?> Yazan: <?php echo $m["konu_ekleyen"];?> Okunma: <?php echo $m["konu_hit"];?> Yorum: 2<span style="float:right;">Tarih: <?php $m["konu_tarih"];?></span></div>
		 <div class="resim">
		  <img src="<?php echo $m["konu_resmi"];?>" alt="" />
		 </div>
		 <p>
