...
foreach($x as $m){
	...
	<div class="bilgi">Kategori : <a href="?git=kategori&id=<?php echo $m["kategori_id"];?>"><?php echo $m["kategori_adi"];?></a> Yazan : <a href="?git=profil&uye=<?php echo $m["uye_adi"];?>"><?php echo $m["uye_adi"];?></a> 
  ...
  <?php echo mb_substr($m["konu_aciklama"],0,300);?>...
	...
	<div class="devam"> 
	<a href="?git=devam&id=<?php echo $m["konu_id"];?>">Devam</a>
	</div>
