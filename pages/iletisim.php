...
if(!$isim || !$baslik || !$aciklama){
		...
		echo '<div class="hata">Konu başlığı 30 karakterden uzun olamaz...</div>';
	}else{
		$kayit = $db_prepare("insert into mesajlar set
		mesaj_gonderen=?,
		mesaj_baslik=?,
		mesaj_kime=?,
		mesaj_aciklama=?
	...
	if($_SESSION){
		...
		<div class="sol2">
		 ...
		 <form action="" method="post">
		  ...
		  <li>Başlık</li>
		  <li><input type="text" name="baslik" placeholder="Konu Başlığı" /></li>
		  <li>Kime</li>
		  <li>
		  <select name="kime">
		  <?php
